...
public class PhiForJoinProceso extends RecursiveTask<Double> {
  ...
  public PhiForJoinProceso(long inicio, long fin, double step) {
    this.inicio = inicio;
    this.fin = fin;
    this.step = step;
  }
 //Implementamos el metodo compute()
  ...
  protected Double  compute() {
    ...
    {      
      ...
      PhiForJoinProceso task_left = new PhiForJoinProceso(ini_izq,fin_izq, step);
      
      PhiForJoinProceso task_right = new PhiForJoinProceso(ini_der,fin_der, step);
      task_left.fork();
      task_right.fork();
